...
\begin{minipage}{0.98\textwidth}
    \begin{minipage}[c]{0.23\textwidth}
        \centering
        \vspace{2pt}
        \raisebox{0.35cm}{\IfFileExists{\logounipar}{\includegraphics[height=1.55cm]{\logounipar}}{\fbox{\rule{0pt}{1.4cm}\ UNIPAR\ }}}
    \end{minipage}
    \hspace{0.6cm}
    \hspace{0.7cm}
...
\hline
\textbf{Integrantes:} &
60000263 - Fellype Gabriel P. dos Santos - \textcolor{red}{Xº}

60301340 - Pedro Kayser dos Santos - \textcolor{red}{Xº} \\
\hline
...
\hline
\textbf{Local ou Demandante:} & \textcolor{red}{Nome do comércio parceiro / cidade} -- em parceria com o curso de Análise e Desenvolvimento de Sistemas, Universidade Paranaense, Toledo Campus I. \\
\hline
...
\hline
\textbf{Quantidade de Público Atingido:} & \textcolor{red}{Aproximadamente XX pessoas} (clientes do comércio parceiro) + disponibilização da página em ambiente público. \\
\hline
\end{tabularx}
...
function adicionarAoCarrinho(id) {
    ...
    salvarCarrinho();   // grava no localStorage
