...
\hline
\textbf{Local ou Demandante:} & Projeto acadêmico vinculado ao curso de Análise e Desenvolvimento de Sistemas -- Universidade Paranaense, Toledo Campus I. \\
\hline
...
\hline
\textbf{Quantidade de Público Atingido:} & Disponibilização da página em ambiente público (repositório aberto no GitHub). \\
\hline
\end{tabularx}
